...
class Calif_Form_Calendario_Seleccionar extends Gatuf_Form {
	public function initFields ($extra = array ()) {
		$choices = array ();
		
		foreach (Gatuf::factory ('Calif_Calendario')->getList (array ('filter' => 'oculto=0', 'order' => 'clave DESC')) as $cal) {
