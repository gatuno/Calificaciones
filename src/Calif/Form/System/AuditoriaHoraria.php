...
class Calif_Form_System_AuditoriaHoraria extends Gatuf_Form {
	...
	public function save ($commit = true) {
		$res = array ('dep' => $this->cleaned_data['departamento'], 'archivo' => $this->data['archivo']['tmp_name'], 'car' => $this->cleaned_data['carrera']);
